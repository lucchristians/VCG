...
#vs
vs = np.loadtxt("/mnt/data0/cg_pmf_test/excl/intra/all_dat.dat")
...
plt.errorbar(vs[:,0]-4,vs[:,1]-vs[0,1],yerr=vs[:,2],fmt='--o',color=colors[2],label="VCG",markersize=4)
plt.legend()
plt.xlim(4.84,25)
plt.ylim(-40.0,5)
...
plt.tight_layout()
plt.savefig("intra_pmf_excl.png")
print("done")
